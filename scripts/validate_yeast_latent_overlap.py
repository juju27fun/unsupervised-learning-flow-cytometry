...
DEFAULT_SYNTHETIC_ROOT = ROOT / "outputs" / "particle_equation_latent_sweeps" / "yeast_budded_template_proof"
DEFAULT_SYNTHETIC_ROOT_P1_FILTERED = ROOT / "outputs" / "particle_equation_latent_sweeps" / "yeast_budded_template_proof_p1_filtered"
DEFAULT_REAL_EMBEDDING_ROOT = (
    ROOT / "outputs" / "pretrained_backbones-4096_20260701" / "particles2snr_f_3class_plus_yeast_quick_offline"
)
DEFAULT_REAL_EVENT_ROOT = ROOT / "outputs" / "pretrained_backbones-4096_20260701" / "yeast_passage_events_p3_4096"
DEFAULT_REAL_EVENT_ROOT_P1_FILTERED = ROOT / "outputs" / "pretrained_backbones-4096_20260701" / "yeast_passage_events_p3_4096_p1_filtered"
DEFAULT_BUDDING_RAW_DIR = Path("/home/intern/Downloads/Yeast_folder/budding")
DEFAULT_YEAST_METADATA = (
    DEFAULT_REAL_EVENT_ROOT / "events_metadata.csv"
)
DEFAULT_OUTPUT_DIR = ROOT / "outputs" / "yeast_latent_overlap_validation" / "template_budding_v1"
DEFAULT_OUTPUT_DIR_P1_FILTERED = ROOT / "outputs" / "yeast_latent_overlap_validation" / "template_budding_v1_p1_filtered"
...
DEFAULT_CONTROL_SYNTHETIC_ROOTS = (
    ROOT / "outputs" / "particle_equation_latent_sweeps" / "yeast_budded_two_particle_proof",
    ROOT / "outputs" / "particle_equation_latent_sweeps" / "yeast_budded_two_particle_proof_budding_ranges",
    ROOT / "outputs" / "particle_equation_latent_sweeps" / "yeast_budded_two_particle_proof_budding_realistic",
)
...
def import_encoding_stack():
    try:
        import torch
        import run_particle_equation_latent_sweeps as latent_sweeps
