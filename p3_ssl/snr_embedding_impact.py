...
from p3_ssl.assessment_figures import (  # noqa: E402
    fit_probe,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "snr_threshold_metrics")
