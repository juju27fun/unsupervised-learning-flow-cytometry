...
from p3_ssl.snr_embedding_impact import (  # noqa: E402
    load_impact_bundle,
    precompute_neighbor_indices,
)
from p3_ssl.snr_threshold_manifolds import (  # noqa: E402
    BASE_CLASS_COLORS,
    MODEL_DISPLAY,
...
from p3_ssl.assessment_figures import normalized_embedding_matrix  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--metrics-root", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "snr_threshold_metrics")
    parser.add_argument("--manifold-root", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "snr_threshold_manifolds")
    parser.add_argument("--output-dir", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "snr_metric_figures")
