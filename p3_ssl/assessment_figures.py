...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--embedding-root", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "pretrained_backbones" / "particles2snr_f_3class_same_input_moment_patchtst_conv1dgap")
    parser.add_argument("--output-dir", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "ssl_assessment")
