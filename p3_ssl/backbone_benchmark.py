...
CONV1DGAP_DEFAULT_CHECKPOINT = (
    REPO_ROOT
    / "artifacts"
    / "SMI_CNN_limitations"
    / "training"
    / "output"
    / "Conv1DGAP-dataset_4c-zoo-conv1dgap"
    / "best_model.pth"
)
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT.parent / "artifacts" / "unsupervised-learning-flow-cytometry" / "pretrained_backbones")
