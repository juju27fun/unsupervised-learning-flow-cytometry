...
DEFAULT_PARTICLE_MANIFEST = (
    REPO_ROOT
    / "particles2SNR_pipeline"
    / "output"
    / "p0_c1_Particles2SNR_F"
    / "event_classification_dataset"
    / "event_manifest.csv"
)
DEFAULT_YEAST_RANGE_SUMMARY = ROOT / "outputs" / "yeast_particle_range_analysis_budding" / "yeast_two_component_range_summary.json"
...
DEFAULT_YEAST_TEMPLATE_ROOT = ROOT / "outputs" / "pretrained_backbones-4096_20260701" / "yeast_passage_events_p3_4096"
DEFAULT_YEAST_TEMPLATE_CALIBRATION = ROOT / "outputs" / "yeast_template_generator_calibration" / "budding_template_calibration_summary.json"
