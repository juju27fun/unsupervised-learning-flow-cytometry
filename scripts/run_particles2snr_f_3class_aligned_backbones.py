...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data-dir", type=Path, default=P0_ROOT / "data" / "processed" / "dataset_Particles2SNR_F_c1_events")
    parser.add_argument("--output-dir", type=Path, default=ROOT / "outputs" / "pretrained_backbones" / "particles2snr_f_3class_same_input_conv1dgap_augmented_train")
